...
INSERT INTO "new_AssignmentDefense" ("clanMemberId", "createdAt", "groupWarId", "id", "rosterUserChampionId") SELECT "clanMemberId", "createdAt", "groupWarId", "id", "rosterUserChampionId" FROM "AssignmentDefense";
...
INSERT INTO "new_Label" ("createdAt", "groupLabelId", "id", "name") SELECT "createdAt", "groupLabelId", "id", "name" FROM "Label";
DROP TABLE "Label";
...
INSERT INTO "new_ClanMember" ("clanId", "createdAt", "id", "rol", "userId") SELECT "clanId", "createdAt", "id", "rol", "userId" FROM "ClanMember";
...
INSERT INTO "new_Clan" ("createdAt", "id", "minimun_prestige", "name", "number_members", "prestige") SELECT "createdAt", "id", "minimun_prestige", "name", "number_members", "prestige" FROM "Clan";
DROP TABLE "Clan";
...
INSERT INTO "new_ChampionLabel" ("championId", "createdAt", "id", "labelId") SELECT "championId", "createdAt", "id", "labelId" FROM "ChampionLabel";
...
INSERT INTO "new_Champion" ("classId", "createdAt", "id", "image", "name") SELECT "classId", "createdAt", "id", "image", "name" FROM "Champion";
DROP TABLE "Champion";
...
INSERT INTO "new_AssignmentAttack" ("clanMemberId", "createdAt", "groupWarId", "id", "rosterUserChampionId") SELECT "clanMemberId", "createdAt", "groupWarId", "id", "rosterUserChampionId" FROM "AssignmentAttack";
...
INSERT INTO "new_GroupLabel" ("createdAt", "id", "name") SELECT "createdAt", "id", "name" FROM "GroupLabel";
...
INSERT INTO "new_GroupWar" ("createdAt", "id", "name") SELECT "createdAt", "id", "name" FROM "GroupWar";
DROP TABLE "GroupWar";
...
INSERT INTO "new_ClassOther" ("createdAt", "icon", "id", "name") SELECT "createdAt", "icon", "id", "name" FROM "ClassOther";
...
INSERT INTO "new_Relic" ("classId", "createdAt", "id", "image", "name") SELECT "classId", "createdAt", "id", "image", "name" FROM "Relic";
DROP TABLE "Relic";
...
INSERT INTO "new_RosterUserChampion" ("championId", "createdAt", "id", "isAscendite", "isAttack", "isDefense", "isDuplicate", "prestige", "rank", "sing", "tier", "userId") SELECT "championId", "createdAt", "id", "isAscendite", "isAttack", "isDefense", "isDuplicate", "prestige", "rank", "sing", "tier", "userId" FROM "RosterUserChampion";
...
INSERT INTO "new_RosterUserRelic" ("createdAt", "id", "isDuplicate", "prestige", "rank", "relicId", "sing", "tier", "userId") SELECT "createdAt", "id", "isDuplicate", "prestige", "rank", "relicId", "sing", "tier", "userId" FROM "RosterUserRelic";
...
INSERT INTO "new_User" ("createdAt", "email", "id", "nickName", "password", "prestige", "userName") SELECT "createdAt", "email", "id", "nickName", "password", "prestige", "userName" FROM "User";
DROP TABLE "User";
